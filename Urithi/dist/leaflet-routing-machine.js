...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		options: {
			...
			summaryTemplate: '<p>{name}</p><h1>{distance},  {time}</h1>',
			timeTemplate: '{time}',
			containerClassName: '',
...
(function() {
	...
	L.Routing.Line = L.LayerGroup.extend({
		...
		options: {
			styles: [
				{color: '#FF1493', opacity: 0.15, weight: 9},
				{color: 'black', opacity: 0.8, weight: 6},
				{color: '#FFFF00', opacity: 1, weight: 2, dashArray: '7,12'}
			],
			missingRouteStyles: [
				{color: '#2F4F4F', opacity: 0.5, weight: 7,dashArray: '10'},
				{color: 'white', opacity: 0.6, weight: 4},
				{color: '#FF1493', opacity: 0.8, weight: 2, dashArray: '7,12'}
			],
			addWaypoints: true,
