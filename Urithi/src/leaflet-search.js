...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyName: 'areaname',		//property in marker.options(or feature.properties for vector layer) trough filter elements in layer,
		propertyLoc: 'geom',			//field for remapping location, using array: ['latname','lonname'] for select double fields(ex. ['lat','lon'] )
